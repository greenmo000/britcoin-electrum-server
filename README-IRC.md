...
current list can be seen by running:
    ...
    electrum-britcoin-server peers
...
`electrum-britcoin-server peers` will always return an empty list.
...
composing the IRC nickname to identify your server on #electrum-britcoin.
